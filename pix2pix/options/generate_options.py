...
class GenerateOptions():
    ...
    def initialize(self, parser):
        print(os.getcwd()+'/pix2pix/single_sketch/')
        parser.add_argument('--dataroot', type=str, default=os.getcwd()+'/pix2pix/single_sketch/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--name', type=str, default='edges2shoes_pretrained', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--dataset_mode', type=str, default='single', help='chooses how datasets are loaded. [unaligned | aligned | single]')
        parser.add_argument('--model', type=str, default='test', help='chooses which model to use. cycle_gan, pix2pix, test')
        ...
        # parser.set_defaults(dataroot=os.path.dirname(os.getcwd())+'/single_sketch/')
        # parser.set_defaults(direction='BtoA')
        # parser.set_defaults(name='edges2shoes_pretrained')
